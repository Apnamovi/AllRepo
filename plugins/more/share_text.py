...
async def share_text(client, message):
    ...
    if len(input_split) == 2:
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("💌 ʙᴏᴛꜱ ᴜᴩᴅᴀᴛᴇs 💌", url=f"https://t.me/Lusifilms")]])
            )                                                   
        return
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
             [[
               ...
               InlineKeyboardButton("💌 ʙᴏᴛꜱ ᴜᴩᴅᴀᴛᴇs 💌", url=f"https://t.me/Lusifilms")
             ]]))      
